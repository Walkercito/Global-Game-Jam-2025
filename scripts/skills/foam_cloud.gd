...
func _ready():
	...
	skill_icon = preload("res://assets/sprites/skills/bubble_cloud.png")
	...
	if area:
		# Usar el autoload SkillManager directamente
		area.collision_layer = 1 << (SkillManager.LAYERS.skill_effects - 1)
